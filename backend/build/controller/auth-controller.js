        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, newUser
                        .save()
                        .then(function (user) {
                        var _a = user.toObject(), image = _a.image, userToToken = __rest(_a, ["image"]);
...
var login = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, user_1.UserModel.findOne({ email: userDetails.email })
                ...
                var _a, image, userToToken, token, refreshToken;
                return __generator(this, function (_b) {
                    if (!user)
                        throw new error_1.default(401, "wrong details !");
                    _a = user.toObject(), image = _a.image, userToToken = __rest(_a, ["image"]);
...
var refreshToken = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var refreshToken_1, user, image, userToToken, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                refreshToken_1 = request.headers.authorization;
                user = jwt_helper_1.default.getUserFromToken(refreshToken_1);
                console.log("USER : " + user);
                image = user.image, userToToken = __rest(user, ["image"]);
...
var getUser = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, user_1.UserModel.findById(userId)
                .then(function (user) {
                var _a = user.toObject(), image = _a.image, userObject = __rest(_a, ["image"]);
                if (user)
