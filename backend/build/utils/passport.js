...
passport_1.default.use(new GoogleStrategy({
    ...
    callbackURL: "/hotix/api/auth/google/callback",
    scope: ["profile", "email"],
}, function (accessToken, refreshToken, profile, done) {
    return __awaiter(this, void 0, void 0, function () {
        var randomUser, existingUser, newUser_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    newUser_1 = new user_1.UserModel(__assign(__assign({}, randomUser), { _id: new mongoose_1.default.Types.ObjectId() }));
                    return [4 /*yield*/, newUser_1.save().then(function (user) {
